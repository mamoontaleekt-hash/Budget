...
assert.equal(count(index, /<script src="\.\/report-enhancements\.js\?v=20260908-phase7"><\/script>/g), 1);
...
assert.ok(index.indexOf('<script src="./comparison-model.js?v=20260908-phase7"></script>') < index.indexOf('<script src="./report-enhancements.js?v=20260908-phase7"></script>'));
...
assert.match(sw, /const CACHE_NAME = "pfm-pwa-v12";/);
