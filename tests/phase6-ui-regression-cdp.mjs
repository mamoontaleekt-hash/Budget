...
try {
  ...
  assert.equal(pwa.active, true); assert.equal(pwa.controlled, true); assert.ok(pwa.keys.includes("pfm-pwa-v12")); assert.equal(pwa.budget, true); assert.equal(pwa.keys.includes("pfm-pwa-v10"), false);
