...
try {
  ...
  assert.ok(pwa.keys.includes("pfm-pwa-v21")); for (const key of ["ux5", "format", "report", "ux4", "ux3", "ux2", "ux1"]) assert.equal(pwa[key], true); assert.equal(pwa.staleReport, false);
